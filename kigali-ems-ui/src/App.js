...
export default function App() {
  ...
  // ==========================================
  // VIEW 0: EULA & PRIVACY POLICY (GATEKEEPER)
  // ==========================================
  if (!eulaAccepted) {
    return (
      <div style={{ padding: '2rem', fontFamily: 'sans-serif', backgroundColor: '#0f0f1a', color: 'white', minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <div style={{ backgroundColor: '#1a1a2e', padding: '3rem', borderRadius: '12px', width: '100%', maxWidth: '800px', border: '1px solid #333', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
          <h1 style={{ color: '#00e5ff', textAlign: 'center', marginBottom: '0.5rem' }}>EULA and Privacy Policy</h1>
          ...
          <div style={{ backgroundColor: '#0f0f1a', padding: '1.5rem', borderRadius: '8px', height: '400px', overflowY: 'auto', border: '1px solid #444', color: '#ccc', lineHeight: '1.6', fontSize: '0.95rem', marginBottom: '2rem' }}>
            <h3 style={{ color: 'white', marginTop: 0 }}>1. Acceptance</h3>
            ...
            <h3 style={{ color: 'white' }}>2. Purpose of the System</h3>
            ...
            <h3 style={{ color: 'white' }}>3. Prohibited Uses</h3>
            ...
            <h3 style={{ color: 'white' }}>4. Data Processed by This System</h3>
            ...
            <h3 style={{ color: 'white' }}>5. Data Minimisation</h3>
            ...
            <h3 style={{ color: 'white' }}>6. Human Oversight Requirement</h3>
            ...
            <h3 style={{ color: 'white' }}>7. Transparency and Accountability</h3>
            ...
            <h3 style={{ color: 'white' }}>8. Limitation of Liability</h3>
            ...
            <h3 style={{ color: 'white' }}>9. Contact and Reporting</h3>
            <p>Any concerns about data use, system misuse, or ethical violations should be reported to: <strong>c.iradukund2@alustudent.com</strong>. For REC-related concerns: Ethics in Research Committee, African Leadership University, Kigali, Rwanda.</p>
          </div>

          <button 
            onClick={() => setEulaAccepted(true)} 
            style={{ backgroundColor: '#00e676', color: '#0f0f1a', border: 'none', padding: '16px 24px', borderRadius: '6px', cursor: 'pointer', width: '100%', fontWeight: 'bold', fontSize: '1.1rem', textTransform: 'uppercase', letterSpacing: '1px' }}
          >
